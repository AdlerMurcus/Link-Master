  ...
  return (
    <div className="px-12 py-12 max-w-4xl mx-auto h-full flex flex-col animate-in fade-in duration-500 overflow-y-auto no-scrollbar">
      <div className="mb-12 flex items-end justify-between shrink-0">
        <div>
          <h2 className="text-3xl font-black text-slate-900 tracking-tighter mb-2 italic underline decoration-blue-500 decoration-4 underline-offset-8">
            {t.sysConfig}
          </h2>
          <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.4em] mt-2">{t.runtimeParams}</p>
        </div>
      ...
      <div className="space-y-12 pb-20">
        ...
        <section className="bg-white p-10 rounded-[40px] border border-slate-200 shadow-sm space-y-8">
          <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
             ...
             <span className="text-[11px] font-black uppercase text-slate-400 tracking-[0.3em]">{t.language}</span>
          </div>
        ...
        <section className="bg-white p-10 rounded-[40px] border border-slate-200 shadow-sm space-y-10">
          <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
             ...
             <span className="text-[11px] font-black uppercase text-slate-400 tracking-[0.3em]">Core Interception Engine</span>
          </div>
        ...
        {/* AI Branding Section */}
        <section className="bg-slate-900 p-12 rounded-[48px] shadow-2xl relative overflow-hidden group border border-white/5">
          ...
          <div className="flex items-center gap-3 mb-10 relative z-10">
             ...
             <span className="text-[11px] font-black uppercase text-blue-400 tracking-[0.4em]">{t.aiEnhanced}</span>
          </div>

          <div className="flex items-center justify-between relative z-10">
            <div className="max-w-[70%]">
              <div className="text-xl font-black text-white mb-3 italic tracking-tight">{t.aiPredict}</div>
      ...
      <div className="mt-auto py-12 text-center shrink-0 border-t border-slate-100/30">
         <span className="text-[10px] text-slate-300 font-mono tracking-[0.6em] uppercase font-black">{t.buildVersion} ID: 1.2.5 LTS</span>
      </div>
    </div>
  );
};
