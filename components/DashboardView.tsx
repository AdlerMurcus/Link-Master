    ...
    <div className="px-10 py-10 h-full flex flex-col bg-white overflow-hidden animate-in fade-in duration-500">
      <div className="flex items-start justify-between mb-10 shrink-0">
        <div className="space-y-2">
          <h2 className="text-3xl font-black text-slate-900 tracking-tighter italic underline decoration-blue-500 decoration-4 underline-offset-8">
            {t.sysStatus}
          </h2>
        ...
        <div className="flex gap-10">
          <div className="text-right">
            <div className="text-[9px] font-black text-slate-300 uppercase tracking-[0.3em] mb-2">{t.requestsProcessed}</div>
            <div className="text-3xl font-black text-slate-900 tracking-tighter tabular-nums flex items-center gap-2">
              <Activity size={20} className="text-slate-200" /> 1,204
            </div>
          </div>
          <div className="text-right border-l border-slate-100 pl-10">
            <div className="text-[9px] font-black text-slate-300 uppercase tracking-[0.3em] mb-2">{t.aiHitRate}</div>
            <div className="text-3xl font-black text-blue-600 tracking-tighter tabular-nums">94.2%</div>
          </div>
        </div>
      </div>
            ...
            return (
              <div key={log.id} className="px-8 py-5 flex items-center gap-6 hover:bg-white transition-all group">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[11px] font-mono text-slate-400 truncate opacity-60 italic">
                    {log.url}
                  </div>
                </div>
